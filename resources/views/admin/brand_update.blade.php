                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('/admin/edit-brand', array($update_data -> id)) }}" method="POST" enctype = "multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="brand_name" name="brand_name" placeholder="Brand Name" class="form-control" value="{{$update_data->brand_name}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <input type="file" id="input_img" name="input_img" class="form-control-file">
                                      </div>
                                    <div class="form-actions form-group"><input type="submit" name="updatebrand" value="Update" class="btn btn-success btn-sm"></div>
                                </form>
                            </div>
                        </div>
                    </div>
