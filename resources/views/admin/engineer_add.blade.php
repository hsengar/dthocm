                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{URL('/admin/Engineer-Create')}}" method="POST" enctype = "multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="ename" name="ename" placeholder="Engineer Name" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="econtact" name="econtact" placeholder="+91 9999 0000 00" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="ecode" name="ecode" placeholder="E00000" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="email" name="email" placeholder="Email ID" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <input type="file" id="input_img" name="input_img" class="form-control-file">
                                      </div>
                                    <div class="form-actions form-group"><input type="submit" name="addeng" value="Add Engineer" class="btn btn-success btn-sm"></div>
                                </form>
                            </div>
                        </div>
                    </div>
