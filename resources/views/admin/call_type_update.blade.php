    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">Update Complaint Type</div>
                            <div class="card-body card-block">
                                <form action="{{ url('/admin/edit-complaint-type', array($update_data -> id)) }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="ctname" name="ctname" placeholder="Complaint Type Name" class="form-control" value="{{$update_data->ct_name}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="ctcharges" name="ctcharges" placeholder="Charges" class="form-control" value="{{$update_data->ct_charges}}">
                                        </div>
                                    </div>
                                    <div class="form-actions form-group"><input type="submit" name="addcalltype" value="Update" class="btn btn-success btn-sm"></div>
                                </form>
                            </div>
                        </div>
                    </div>
