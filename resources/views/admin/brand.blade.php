                                ...
                                <form action="{{URL('/create-brand')}}" method="POST" enctype = "multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" id="brand_name" name="brand_name" placeholder="Brand Name" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <input type="file" id="input_img" name="input_img" class="form-control-file">
                                      </div>
                                    <div class="form-actions form-group"><input type="submit" name="addbrand" value="Add Brand" class="btn btn-success btn-sm"></div>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View BRANDS</strong>
                            </div>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src='{{ asset('images/uploaded/brands') }}/{{$data->brand_logo}}' height='32px'></td>
