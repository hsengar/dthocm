...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="animated fadeIn">
                ...
                <div class='row'>
                    <div class="col-lg-12">
                        <a  style="float:right;" href='{{URL('/admin/customerDownloadCSV')}}'><div class='btn btn-sm' style='background-color:green; color:#FFFFFF;' ><i class="far fa-file-excel"></i> Download</div></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Customers</strong>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$data->cust_alt_mobile}}</td>
                                                <td>{{$data->cust_email}}</td>
                                                <td>{{$data->cust_city}}</td>
                                                <td>{{$data->cust_state}}</td>
                                                <td><form action = '{{URL('/admin/delete-customer')}}' method='post'>@csrf<input type='hidden' name='id' value='{{$data->id}}'><button type='submit' name='delete_calltype' class='btn btn-sm' style='background-color:red; color:#FFFFFF;'><i class='far fa-trash-alt'></i></button></form></td>
                                                <td><a href='/admin/Customers-Edit/{{$data->id}}'><div class='btn btn-sm' style='background-color:#00B0F0; color:#FFFFFF;' ><i class='far fa-edit'></i></div></a></td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                </table>
