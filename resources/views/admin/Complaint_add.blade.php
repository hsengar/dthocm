                ...
                <div class="row">
                        <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form action="{{URL('/admin/ComplaintRegister-Add')}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <small>Customer Name :</small><br><strong>{{$customer_data->cust_name}}</strong>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                        <small>Customer Mobile Number :</small><br><strong>{{$customer_data->cust_mobile}}</strong>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                        <small>Customer Alternate Mobile Number :</small><br><strong>{{$customer_data->cust_alt_mobile}}</strong>
                                                </div>
                                            </div>
                                            <div class="row col-lg-12">
                                                <div class="form-group">
                                                        <small>Customer Address :</small><br><strong>{{$customer_data->cust_address}}</strong>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    <div class="form-group col-lg-4">
                                                        <small>City :</small><br><strong>{{$customer_data->cust_city}}</strong>
                                                    </div>
                                                    <div class="form-group col-lg-4">
                                                            <small>State :</small><br><strong>{{$customer_data->cust_state}}</strong>
                                                    </div>
                                                    <div class="form-group col-lg-4">
                                                            <small>Email :</small><br><strong>{{$customer_data->cust_email}}</strong>
                                                    </div>
                                            </div>
                                            <input type="hidden" id="customer" name="customer" placeholder="Customer ID" class="form-control" value="{{$customer_data->id}}" readonly>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                            <select name="complaint_type" id="complaint_type" class="form-control">
                                                                ...
                                                                <option value="{{$data->id}}">{{$data->ct_name}}</option>
                                                                @endforeach
                                                            </select>
                                                </div>
                                            </div>
