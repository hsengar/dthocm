    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="animated fadeIn">
                ...
                <div class="row">
                        <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">Engineer Report</div>
                                    <div class="card-body card-block">
                                    <form action="{{URL('/admin/Report-EngineerCreate')}}" method="POST">
                                        @csrf
											<div class="form-group">
                                                            <select name="engineer" id="engineer" class="form-control">
                                                                <option value="">Please select Engineer</option>
                                                                @foreach($engineers as $engineer)
                                                                <option value="{{$engineer->id}}">{{$engineer->e_name}}</option>
                                                                @endforeach
                                                            </select>
                                            </div>
											<div class="form-group">
                                                <div class="input-group">
                                                    <input type="date" id="fromdate" name="fromdate" class="form-control" value="">
                                                </div>
                                            </div>
											<div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-actions form-group"><input type="submit" name="registercall" value="Submit" class="btn btn-success btn-sm"></div>
                                    </form>
                                    </div>
                                </div>
                            </div>
