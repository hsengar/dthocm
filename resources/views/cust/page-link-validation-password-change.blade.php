        ...
        <div class="container">
            <div class="login-content">
				...
				<div class="login-logo">
                    ...
                    <form action="{{URL('/customer-link-changepassword')}}" method="POST">
                        @csrf
                            <div class='row'>
						...
						<input type='hidden' name='authkey' value='{{$authkey}}' readonly>
                        <div class="checkbox">
						...
						<input type="submit" name="login" value="Submit" class="btn btn-success btn-flat m-b-30 m-t-30">
