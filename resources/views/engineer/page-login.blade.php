...
<head>
        ...
        <title>Engineer Login | DTHOCM</title>
...
<style>
body  {
  background-image: url("images/log_main_engineer.jpg");
        ...
        <div class="container">
            <div class="login-content">
				...
				<div class="login-logo">
                    ...
                    <form action="{{URL('/engineer-checklogin')}}" method="POST">
                        @csrf
                            <div class='row'>
						...
						<input type="submit" name="login" value="Sign in" class="btn btn-success btn-flat m-b-30 m-t-30">
                      <!---  <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="login">Sign in</button>--->
						...
						<div class="register-link m-t-15 text-center">
                            <!---<p>New to DTHOCM ? <a href="customer-register"> Sign-up Here</a></p>--->
                        </div>
                    </form>
                </div>
            </div>
