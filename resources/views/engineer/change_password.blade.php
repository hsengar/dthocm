                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{URL('/engineer-change-password')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="password" id="old_pass" name="old_pass" placeholder="Old Password" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="password" id="New_Password" name="New_Password" placeholder="New Password" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                    ...
                                    <div class="form-actions form-group"><input type="submit" name="submit" value="Change Password" class="btn btn success btn-sm"></div>
                                </form>
                            </div>
                        </div>
                    </div>
